...
train = pd.read_csv('')
trade = pd.read_csv('')
# loads train and trade datasets into a pandas dataframe

train = train.set_index(train.columns[0]) #sets first column as index and cleans for both
train.index.names = ['']
...
if_using_td3 = False
if_using_sac = False
#establishes what RL agent is being used
